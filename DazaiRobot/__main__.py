...
⋆─────────────────────⋆
[➠](https://graph.org/file/b30ced670900d3d3d3417.jpg) ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs.
"""

buttons = [
    [ 
        InlineKeyboardButton(text="sᴜᴍᴍᴏɴ ᴍᴇ", url="https://t.me/{BOT_USERNAME}?startgroup=true"),
